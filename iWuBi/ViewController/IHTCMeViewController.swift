...
class IHTCMeViewController: UIViewController {
    ...
    fileprivate var titles = ["0": "收藏夹:收藏的字,五笔版本:86版或98版,主题外观:暗黑or浅色,切换App图标:选择你的最爱", "1": "应用内评分:欢迎给\(kAppName)打评分！,AppStore评价:欢迎给\(kAppName)写评论!,分享给朋友:与身边的好友一起学习！,文字转语音:TTS (Text-To-Speech)",
...
extension IHTCMeViewController
{
    func setupUI() {
        ...
        titles = ["0": "收藏夹:收藏的字,五笔版本:86版或98版,主题外观:暗黑or浅色", "1": "应用内评分:欢迎给\(kAppName)打评分！,AppStore评价:欢迎给\(kAppName)写评论!,分享给朋友:与身边的好友一起学习！,文字转语音:TTS (Text-To-Speech)",
